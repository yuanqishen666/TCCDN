...
#sys.path.append("/home/rtx2080ti/yqs/CrowdDet-V4_modify_3/lib")
#import lib
#print("sys.modules ===>",sys.modules.values())
...
def train_worker(rank, train_config, network, config):
    ...
    # build data provider
    crowdhuman = CrowdHuman_data.CrowdHuman(config, if_train=True, if_test=False)
...
def run_train():
    ...
    parser.add_argument('--model_dir', '-md', default="rcnn_emd_simple", required=False, type=str)
