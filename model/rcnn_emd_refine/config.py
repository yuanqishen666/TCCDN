...
#     root_folder = '/data0/luzeng_data/data/crowdhuman'
#     image_folder = '/data0/luzeng_data/data/crowdhuman/Images'
#     train_source = os.path.join('/data0/luzeng_data/data/crowdhuman/annotation_train.odgt')
#     eval_source = os.path.join('/data0/luzeng_data/data/crowdhuman/annotation_val.odgt')
#
# class Config:
#     output_dir = 'outputs'
#     model_dir = os.path.join(output_dir, 'model_dump')
#     eval_dir = os.path.join(output_dir, 'eval_dump')
#     init_weights = '/data0/luzeng_data/CrowdDet/weight/resnet50_fbaug.pth'
class Crowd_human:
    class_names = ['background', 'fbox','hbox']
    num_classes = len(class_names)
...
class Config:
    ...
    model_dir = os.path.join(output_dir, 'model_dump')
    eval_dir = os.path.join(output_dir, 'eval_dump')
    init_weights = os.path.join(root_dir, 'weight/resnet50_fbaug.pth')
    ...
    class_names2id = dict(list(zip(class_names, list(range(num_classes)))))  # {background: 0, person: 1}
    gt_boxes_name = 'fbox'  # 从odgt取出的gt
    ...
    max_epoch = 30
    lr_decay = [20, 26]
    nr_images_epoch = 15000  # 一个epoch几张图(crowdhuman的训练图片有15000张)
